...
@echo - 轴心与同盟 Axis Allies 联机专用正式版 更新工具 by 海盗(Spica)
@echo -------------------------------------------------------------------
...
set path=https://ghfile.geekertao.top/https://raw.githubusercontent.com/cafel176/AAMod/refs/heads/main/Release/
